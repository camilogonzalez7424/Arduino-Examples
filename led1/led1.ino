...
#define redpin 11                                                  //pwm output for RED anode use 1K resistor
#define greenpin 9                                                //pwm output for GREEN anode use 2K resistor
#define bluepin 10                                                 //pwm output for BLUE anode use 1K resistor
